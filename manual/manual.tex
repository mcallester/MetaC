...
\noindent {\bf Run Time Errors and Breakpoints.} The MetaC procedure {\tt berror(char *)} enters the gdb debugger. Typing the continue command
...
\noindent {\bf Segmentation Faults.} Segmentation faults, and other types of errors, are trapped by gdb directly.  In this case the
NIDE will enter the gdb debugger.  However, in this case the normal gdb continue command will not return to the code buffer.
To recover one types {\tt print return\_to\_NIDE()} to gdb which will typically
